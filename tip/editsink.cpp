...
STDAPI CSaenaruTextService::OnEndEdit(ITfContext *pContext, TfEditCookie ecReadOnly, ITfEditRecord *pEditRecord)
{
    DEBUGPRINTFEX(100, (TEXT("CSaenaruTextService::OnEndEdit()\n")));
...
BOOL CSaenaruTextService::_InitTextEditSink(ITfDocumentMgr *pDocMgr)
{
    ITfSource *pSource;
    BOOL fRet;
