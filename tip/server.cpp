...
void BuildGlobalObjects(void)
{
    ...
    g_ObjectInfo[0] = new CClassFactory(c_clsidSaenaruTextService,
                                        CSaenaruTextService::CreateInstance);
...
{
    CSaenaruTextService::RegisterCategories(FALSE);
    CSaenaruTextService::UnregisterProfiles();
    CSaenaruTextService::UnregisterServer();
...
STDAPI DllRegisterServer(void)
{
    ...
    if (!CSaenaruTextService::RegisterServer() ||
        !CSaenaruTextService::RegisterProfiles() ||
        !CSaenaruTextService::RegisterCategories(TRUE))
    {
