...
{
    *pclsid = c_clsidSaenaruTextService;
    return S_OK;
}
...
STDAPI CSaenaruTextService::IsStoreSerializable(REFGUID guidProperty, ITfRange *pRange, ITfPropertyStore *pPropertyStore, BOOL *pfSerializable)
{
...
STDAPI CSaenaruTextService::CreatePropertyStore(REFGUID guidProperty, ITfRange *pRange, ULONG cb, IStream *pStream, ITfPropertyStore **ppStore)
{
