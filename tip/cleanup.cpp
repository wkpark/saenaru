...
STDAPI CSaenaruTextService::OnStartCleanupContext()
{
    _fCleaningUp = TRUE;
    return S_OK;
}
...
STDAPI CSaenaruTextService::OnEndCleanupContext()
{
    _fCleaningUp = FALSE;
    return S_OK;
}
...
STDAPI CSaenaruTextService::OnCleanupContext(TfEditCookie ecWrite, ITfContext *pContext)
{
...
BOOL CSaenaruTextService::_InitCleanupContextDurationSink()
{
...
void CSaenaruTextService::_UninitCleanupContextDurationSink()
{
...
BOOL CSaenaruTextService::_InitCleanupContextSink(ITfContext *pContext)
{
...
void CSaenaruTextService::_UninitCleanupContextSink(ITfContext *pContext)
{
